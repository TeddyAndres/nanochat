...
def run_training_with_bias_scale(bias_scale):
    ...
    cmd = [
        ...
        f"--run=sparse 65kvoc 1kstep unembedlr0.009 fasteval logit0.95 coldbias{bias_scale}",
        "--sparse-mode",
        "--window-pattern", "L",
        "--sparse-manifest", "manifests/d6_2kseq_32batch_1kstep_noaccum.json",
        "--log-every", "10",
        "--eval-every", "1000",
        "--unembedding-lr=0.009",
        "--core-metric-every", "-1",
        "--total-batch-size", "65536",
        "--sparse-logit-scale", "0.95",
        "--aspect-ratio", "64",
        "--warmup-ratio", "0",
        "--warmdown-ratio", "0.5",
...
def main():
    ...
    bias_scales = [4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536]
